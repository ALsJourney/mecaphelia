...
export default function Page() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg sm:text-xl font-semibold tracking-tight text-black">mecaphelia</span>
            </div>
            <div className="flex items-center gap-4 sm:gap-8">
              <Link href="#features" className="hidden sm:inline text-sm text-gray-600 hover:text-black transition-colors">
                Funktionen
              </Link>
              <Link href="#benefits" className="hidden sm:inline text-sm text-gray-600 hover:text-black transition-colors">
                Vorteile
              </Link>
              <Link href="/sign-in">
                <Button variant="default" className="bg-black text-white hover:bg-gray-800 text-sm sm:text-base">
                  Jetzt starten
                </Button>
              </Link>
            </div>
      ...
      {/* Hero Section */}
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-40">
        <div className="grid gap-8 sm:gap-16 lg:grid-cols-2 lg:gap-20">
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-black text-balance lg:text-6xl">
              Behalte den Überblick über deine Fahrzeuge.
            </h1>
            <p className="mt-4 sm:mt-8 text-base sm:text-lg leading-relaxed text-gray-600 text-pretty">
            ...
            <div className="mt-6 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-gray-300 text-black hover:bg-gray-50 bg-transparent w-full sm:w-auto"
              >
                Mehr erfahren
              </Button>
            </div>
      ...
      {/* Features Section */}
      <section id="features" className="border-t border-gray-200 bg-gray-50 py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-black text-balance">Alles, was du brauchst</h2>
            <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-gray-600 text-pretty">
              Verwalte mehrere Fahrzeuge, dokumentiere Probleme und behalte den Überblick über Wartungsintervalle.
            </p>
          </div>
          <div className="mx-auto mt-10 sm:mt-16 lg:mt-20 grid max-w-5xl gap-8 sm:gap-12 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section id="benefits" className="py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 sm:gap-16 lg:grid-cols-2 lg:gap-32">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-black text-balance">Spare Zeit und Geld</h2>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-gray-600 text-pretty">
              ...
              <ul className="mt-6 sm:mt-10 space-y-4">
      ...
      {/* CTA Section */}
      <section className="border-t border-gray-200 bg-black py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center lg:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-white text-balance lg:text-5xl">
            Bereit, deine Fahrzeuge zu verwalten?
          </h2>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-gray-300 text-pretty">
      ...
      <footer className="border-t border-gray-200 bg-white py-8 sm:py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs sm:text-sm text-gray-500 text-center">© 2025 mecaphelia. Alle Rechte vorbehalten.</p>
          </div>
        </div>
      </footer>
    </div>
